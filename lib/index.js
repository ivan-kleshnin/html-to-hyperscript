...
var htmlToHs2 = (0, _ramda.curry)(function (opts, html) {
  ...
  var renderProps = function renderProps(depth, node) {
    ...
    var id = (0, _helpers.findName)("id", attrs);
    var style = (0, _helpers.findName)("style", attrs);
    var props = (0, _ramda.reduce)(function (memo, item) {
      return (0, _ramda.assocPath)(["attributes", item.name], item.value, memo);
    }, {}, (0, _helpers.rejectNames)(["id", "style"], attrs));
    if (id) {
      props.id = id;
    }
    if (style) {
    ...
    if (!(0, _ramda.keys)(props.attributes).length) {
      props = dissoc("attributes", props);
    }
